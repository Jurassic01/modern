...
<form action="update" method="post">
  ...
  <input type="text" id="name" name="title" value="<%= task.getTitle() %>" required><br>
  <label for="status">New status:</label>
  <input type="number" id="status" name="status" value="<%= task.getStatus() %>" min="0" step="0.01" required><br>
